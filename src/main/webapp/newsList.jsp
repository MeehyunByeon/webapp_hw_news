...
<%--    <meta charset="UTF-8">--%>
<%--    <meta name="viewport" content="width=device-width, initial-scale=1">--%>
<%--    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD6 5VohhpuuCOmLASjC" crossorigin="anonymous"> <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>--%>
<%--    <title>뉴스 관리 앱</title>--%>
<%--</head>--%>
<%--<body>--%>
<%--<div class="container w-75 mt-5 mx-auto">--%>
...
<%--                <a href="news.nhn?action=deleteNews&aid=${news.aid}"> <span class="badge bg-secondary"> &times;</span>--%>
<%--                </a>--%>
<%--            </li>--%>
<%--        </c:forEach>--%>
<%--    </ul>--%>
...
<%--    <button class="btn btn-outline-info mb-3" type="button" data-bs-toggle="collapse" data-bs-target="#addFrom" aria-expanded="false" aria-controls="addFrom">뉴스 등록</button>--%>
<%--</div>--%>
<%--<div class="collapse" id="addForm">--%>
<%--    <div class="card card-body">--%>
<%--        <form method="post" action="/news.nhn?action=addNews" enctype="multipart/form-data">--%>
